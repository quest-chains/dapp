...
export interface IQuestChainTokenInterface extends utils.Interface {
  functions: {
...
export interface IQuestChainToken extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IQuestChainTokenInterface;
